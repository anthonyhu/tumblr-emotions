...
def ptb_raw_data(data_path=None, char=False):
  ...
  if char:
    ...
    file_begin = 'ptb.'
  train_path = os.path.join(data_path, file_begin + 'train.txt')
  valid_path = os.path.join(data_path, file_begin + 'valid.txt')
  test_path = os.path.join(data_path, file_begin + 'test.txt')
